...
normal_image = Image.open('image.jpg')
...
def central(image, position, direction):
        if(direction == 'x'):
                ...
                fxi1 = function(image, xi1)
                f_xiderivated = (fxi1 - fximinor1)/2
                return f_xiderivated
        if(direction == 'y'):
...
masc_image = grayscale_image.copy()
